This archive contains the Matlab and Octave interface of NFFT 3.5.1 compiled for
64-bit Windows using GCC 9.1.0 x86_64-w64-mingw32 with march=core2, FFTW 3.3.8 and Matlab and Matlab R2015b and Octave 5.1.0.
